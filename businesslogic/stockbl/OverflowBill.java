...
public class OverflowBill{
	...
	public OverflowBill(String id,String storehouse,User operator,Commodity commodity,String model,int systemData,int actualData,String note){
		this.id=id;
