...
public class StrategyDataServiceImpl implements StrategyDataService,java.io.Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 8583857858318712193L;
	...
	public StrategyDataServiceImpl() {
	...
	public StrategyDataServiceImpl(ArrayList<DiscountStrategyPO> discount,ArrayList<VoucherStrategyPO> voucher,
			ArrayList<CombinationStrategyPO> combination,ArrayList<GiftStrategyPO> gift,
			ArrayList<GiftBasedOnTotalMoneyPO> gbotm,ArrayList<VoucherBasedOnTotalMoneyPO> vbotm){
