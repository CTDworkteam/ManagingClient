...
public class SalesBillVO {
	...
	private String note;
	public SalesBillVO(String id, String client, String defaultOperator,
	...
	public ArrayList<SalesBillItemVO> getList() {
		return list;
	}
	public void setList(ArrayList<SalesBillItemVO> list) {
		this.list = list;
	}
