...
import blservice.*;
public class FinanceBLServiceStub implements FinanceBLService{
	private FinanceDataServiceStub service = new FinanceDataServiceStub();
	public FinanceBLServiceStub(){
