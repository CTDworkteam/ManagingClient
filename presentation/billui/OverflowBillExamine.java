...
public class OverflowBillExamine {
	...
	class buttonListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			OverflowBillVO theBill=new OverflowBillVO(vo.getId(),fieldStorehouse.getText(),fieldCommodity.getText(),fieldModel.getText(),Integer.parseInt(fieldRecordNumber.getText()),Integer.parseInt(fieldActualNumber.getText()));
			...
			Bill bill=new Bill();
			ResultMessage result=bill.approveOverflowBill(theBill);
			String message="";
