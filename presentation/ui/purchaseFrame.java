...
public class purchaseFrame extends JFrame{
	...
	private purchaseHomePage homePage=new purchaseHomePage();
	private purchaseCustomerManagement customerManagement=new purchaseCustomerManagement();
	private purchaseImportPanel importPanel=new purchaseImportPanel();
...
class purchaseHomePage extends JPanel{
...
class purchaseCustomerManagement extends JPanel{
	...
	Object[][] rowData={{"0001","进货商",1,"迪","XX","XX","XX","XX","XX"}};
...
class purchaseImportPanel extends JPanel{
	...
	JLabel importTitle=new JLabel("新建进货单");
	...
	String[] returnColumn={"进货单编号","商品名","商品型号","单价","数量"};
