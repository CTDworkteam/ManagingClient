...
public class CopySalesReturn {

	JFrame frame=new JFrame();
	JPanel panel=new JPanel();
	
	JLabel label=new JLabel("销售退货单");
	...
	class confirmListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			for(int t=0;t<size;t++){
				...
				SalesReturnBillVO.SalesReturnBillItemVO vo=new SalesReturnBillVO().new SalesReturnBillItemVO((String)table.getValueAt(t, 0),(String)table.getValueAt(t, 1),(int)table.getValueAt(t, 2),(double)table.getValueAt(t, 3),(double)table.getValueAt(t, 4),(String)table.getValueAt(t, 5));
				items.add(vo);
			}
