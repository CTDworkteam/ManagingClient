...
public class ProcessListShowSalesReturn {
	...
	public void go(SalesReturnBillVO vo,UserJob job){
		...
		ArrayList<SalesReturnBillItemVO> billItem=vo.getList();
	...
	class buttonCopyListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			if(result==ResultMessage.Failure){
				...
				Thread thread=new Thread(r);
				thread.start();
				CopySalesReturn copy=new CopySalesReturn();
				copy.go(vo.getId());
			}
		}
	}
