...
public class ProcessListShowPurchaseReturn {
	...
	public void go(PurchaseReturnBillVO vo,UserJob job){
		...
		ArrayList<PurchaseReturnBillItemVO> billItem=vo.getList();
	...
	class buttonCopyListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			if(result==ResultMessage.Failure){
				...
				Thread thread=new Thread(r);
				thread.start();
				CopyPurchaseReturn copy=new CopyPurchaseReturn();
				copy.go(vo.getId());
			}
		}
	}
